...
import { US2_PRODUCT_ID, CAMPAING_ID } from "@logic/consts";
...
export default function ButtonsBlock({ isChecked }) {
	...
	return (
		<div className={styles.container}>
			...
			>
				Add my First Hydrolyzed Collagen Peptides Bottle to My order!
			</button>
			<button
