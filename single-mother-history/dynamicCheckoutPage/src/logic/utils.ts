import { GenericObject } from "@ui/types/types";
import { FetchOutput } from "@ui/types/fetching.types";
import { GA_CLICK_EVENT, GA_PURCHASE_EVENT, GA_ADD_TO_CART, GA_BEGINCHECKOUT_EVENT } from "@logic/consts";
import { PurchaseEvent, EventData, BeginCheckoutEvent, AddToCartEvent } from "@ui/types/types";
...
export const sendMetaAddToCartEvent = (): void =>{
  //@ts-ignore
  fbq('track', 'AddToCart');
};
...
export const sendGAAddToCart = (addToCartEvent: AddToCartEvent): void => {
