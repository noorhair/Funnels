...
const Select = forwardRef<FormFieldRef, SelectProps>(function InputFunction(props, ref) {
    ...
    return (
        <div 
            className={`${styles.select_container} ${mood === "error" ? styles.field_with_error : " "}`}
        >
            ...
            <div className={styles.div_select}>
                ...
                <svg fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 330 330" >
